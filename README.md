...
[![Build and Release](https://github.com/pluggero/docker-debian12-ansible/actions/workflows/release.yml/badge.svg)](https://github.com/pluggero/docker-debian12-ansible/actions/workflows/release.yml) [![Docker pulls](https://img.shields.io/docker/pulls/pluggero/docker-debian12-ansible.svg?maxAge=2592000)](https://hub.docker.com/r/pluggero/docker-debian12-ansible/)
...
docker run --name test-container -d --privileged \
  ...
  --cgroupns=host \
  pluggero/docker-debian12-ansible:latest
```
...
# Visit: https://github.com/pluggero/docker-debian12-ansible/actions/workflows/release.yml
...
docker pull pluggero/docker-debian12-ansible@sha256:<digest-from-checksums.txt>

# Or verify your existing image digest matches
docker inspect --format='{{index .RepoDigests 0}}' pluggero/docker-debian12-ansible:latest
```
